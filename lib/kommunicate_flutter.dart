...
class KommunicateFlutterPlugin {
  ...
  static Future<dynamic> launchConversationWithUser(dynamic userObject) async {
    return await _channel.invokeMethod('launchConversationWithUser', jsonEncode(userObject));
  }
